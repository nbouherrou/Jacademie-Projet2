...
/**
 * Classe qui represente la clé en BDD d'une Chanson. Elle implemente
 * "Serializable", hash et equals afin d'etre utilisée comme une clé prrimaire
 * composée
 * 
 * @author jacademie-team
 *
 *         ANNOTATION - MAPPING On declare la classe pour l'injecter dans comme
 *         composite-id
 */
@Embeddable
public class ChansonId implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6761167484683322479L;

	/**
	 * ANNOTATION - MAPPING Colonne "CHANSON_ID_PK_CHANSON"
	 */
	@Column(name = "CHANSON_ID_PK_CHANSON")
	private Integer idChanson;

	/**
	 * ANNOTATION - MAPPING Colonne "CHANSON_ID_PK_ALBUM_ID"
	 * 
	 * @see AlbumId
	 */
	 ...
	 * 
	 * @param Integer
	 *            idChanson : numeroChanson
	 * @param AlbumId
	 *            albumID : Objet AlbumId composé du codeAlbum et du codeArtiste
	 */
	...
	public String toString() {
		return "ChansonId [idChanson=" + idChanson + ", albumID="
				+ albumID.toString() + "]";
	}
