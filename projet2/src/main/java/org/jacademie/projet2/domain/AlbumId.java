...
/**
 * Classe qui represente la clé en BDD d'un Album. Elle implemente
...
public class AlbumId implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1419511701224432901L;

	/**
	 * ANNOTATION - MAPPING Colonne "ALBUM_ID_PK_ALBUM"
	 */
	@Column(name = "ALBUM_ID_PK_ALBUM")
	private Integer idAlbum;

	/**
	 * ANNOTATION - MAPPING Colonne "ALBUM_ID_PK_ARTISTE"
	 */
	...
	public boolean equals(Object obj) {
		...
		return (this.idAlbum.longValue() == other.getIdAlbum().longValue())
				&& (this.idArtiste.longValue() == other.getIdArtiste()
						.longValue());
	}
